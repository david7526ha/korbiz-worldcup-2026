...
const T = {
  en:{
    ...
    bracketLock:"Bracket picks lock: June 28, 2026 11:00 PM ET (kickoff of Round of 32 opener)",
  ...
  es:{
    ...
    bracketLock:"Bracket picks cierran: 28 jun 2026 11:00 PM ET (inicio del primer partido de Octavos de 32)",
  ...
  ko:{
    ...
    bracketLock:"브래킷 픽 마감: 2026년 6월 28일 밤 11시 (ET) — 32강 첫 경기 킥오프 직전",
